...
SCHOOLS = {
    ...
    "school2": {"name_ar": "مدرسة النور الأساسية",           "emoji": "🌟", "color": "#2563eb"},
    "school3": {"name_ar": "مدرسة الفجر للبنات",             "emoji": "🌸", "color": "#9333ea"},
    "school4": {"name_ar": "مدرسة السلام الأساسية",          "emoji": "🕊️", "color": "#0891b2"},
}
...
<div class="card">
  ...
  <input type="text" id="cid" maxlength="8" inputmode="numeric" placeholder="أدخل الرقم المدني" oninput="this.value=this.value.replace(/\\D/g,'')"/>
  <button class="btn" id="btn" onclick="doSearch()">🔍 ابحث عن الشهادة</button>
  <div id="result"></div>
</div>
<footer>تم التطوير بواسطة أخصائي نظم مدرسية: عاصم ناصر الكاسبي<br/>FuticFlow Automation Systems &copy; 2026</footer>
<script>
